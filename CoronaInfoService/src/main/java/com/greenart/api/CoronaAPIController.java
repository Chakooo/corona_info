...
public class CoronaAPIController {
    ...
    public Map<String,Object> getCoronaInfo(
        ...
        for(int i=0; i<nList.getLength(); i++){
            ...
            // // System.out.println(getTagValue("accDefRate", elem)); //누적확진률
            // System.out.println(getTagValue("accExamCnt", elem)); //누적 검사수
            // System.out.println(getTagValue("accExamCompCnt", elem)); //누적 검사 완료수
        ...
        resultMap.put("message","데이터가 입력됐습니다..");
