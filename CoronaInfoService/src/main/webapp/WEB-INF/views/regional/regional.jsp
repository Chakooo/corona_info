        ...
        <div class="right_area">
            <div class="content_head">
                ...
                <span class="social_distance">
                    ...
                    <span clas="distance_level">3단계</span>
                </span>
                ...
                <div class="content_area">
                    ...
                    <div>
                        <p>신규 확진</p>
                        <p id="newDecideCnt">100,000</p>
                    </div>
                    <div>
                        <p>격리 중</p>
                        <p id="isolateCnt">100,000</p>
                    </div>
                    <div>
                        <p>격리 해제</p>
                        <p id="clearIsolateCnt">100,000</p>
                    </div>
                </div>                
                <div class="content_area">
                    <div>
                        <p>백신 1차 접종</p>
                        <p id="vaccineFirstCnt">123,322</p>
                    </div>
                    <div>
                        <p>백신 2차 접종</p>
                        <p id="vaccineSecondCnt">213,123</p>
                    </div>
                    <div>
                        <p>백신 예약 부제</p>
